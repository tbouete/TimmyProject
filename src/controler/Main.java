...
public class Main 
{
	...
	public static void main(String[] args) 
	{
		...
		Property toast = new Flat("Paris", Orientation.NORTH, 50, 5, 6, 1500);
		System.out.println(toast.getClass().getName());
		...
		/*
		 ...
		 Person starfishPatrickBuyer = new Person("Bikini Bottom Two","starfishTrickPa@lovekrustypate.com", "Patrick Wonderful Starfish","+330604468764");
		 
		 krustyKrabAgency.registerSeller(spongeBobSeller,new Date(2017,1,27));
		 */
